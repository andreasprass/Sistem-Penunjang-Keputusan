            ...
            <div class="div2 d-flex align-items-center justify-content-center">
                <div class="form-box p-4 rounded">
                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        @enderror
                        <input type="password" name="confirm_password" id="confirm_password"class="form-control rounded-pill @error('confirm_password') is-invalid mb-0 @enderror" placeholder="Konfirmasi Password">
                        @error('confirm_password')
                        <div class="invalid-feedback mb-3 ms-2">
                        {{ $message }}
                        </div>
                        @enderror
                        <button type="submit" class="form-control rounded-pill mb-4 btn bg-info text-white">Daftar</button>
                    </form>
                </div>
            </div>
        </div>
